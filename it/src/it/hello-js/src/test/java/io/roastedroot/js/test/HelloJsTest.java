...
class HelloJsTest {
    ...
    class JsTestModule {
        ...
        JsTestModule() {
            var builtins =
                    // TODO: the construction of both Builtins and Invokables
                    // should be generated by the annotation processor
                    Builtins.builder("my_js").add(JsTestModule_Builtins.toBuiltins(this)).build();
    ...
    public void helloJsModule() {
        ...
        // Act
        helloJsModule.exec("my_js.my_java_check(my_js.my_java_func(40, 2));");
    ...
    public void useJavaRefs() {
        ...
        // Act
        helloJsModule.exec("my_js.my_java_ref_check(my_js.my_java_ref());");
